...
class _PlanificacionesScreenState extends State<PlanificacionesScreen> {
  ...
  Widget build(BuildContext context) {
    const azul = PlanificacionesScreen.primaryColor;
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Planificación Académica', style: titleStyle),
                  const SizedBox(height: 4),
                  Text(
                    'Consulta los periodos evaluativos y la estructura curricular definida por la institución.',
                    style: subtleStyle,
                  ),
                ],
              ),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Periodos Escolares (P1 - P4)', style: sectionTitleStyle),
              ...
              builder: (context, snapshot) {
                ...
                if (periodos.isEmpty) {
                  return _buildEmptyState(
                    'La institución aún no ha configurado los periodos.',
                  );
                }
  ...
  Widget _buildPlanAnualSection({TextStyle? sectionTitleStyle}) {
    return Card(
      elevation: 0.8,
      margin: EdgeInsets.zero,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
  ...
  Widget _buildPlanCard(String title, IconData icon, Color color) {
    return InkWell(
      ...
      onTap: () {
        // SOLO LECTURA: aquí después navegas a detalle (también de lectura)
