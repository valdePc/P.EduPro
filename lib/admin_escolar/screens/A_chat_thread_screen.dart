...
class _AChatThreadScreenState extends State<AChatThreadScreen> {
  ...
  CollectionReference<Map<String, dynamic>> get _msgsCol => _threadRef.collection('messages');
  ...
  Future<void> _send() async {
    ...
    try {
      ...
      batch.set(msgRef, {
        'text': text,
        'senderRole': widget.isAdmin ? 'admin' : 'other',
        'senderId': widget.isAdmin ? 'admin' : 'user',
              ...
              builder: (context, snap) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    final mine = widget.isAdmin ? (role == 'admin') : false;
